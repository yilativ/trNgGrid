...
module TrNgGrid{
    ...
    var isCustomizedProperty = "isCustomized";
    var isAutoGeneratedProperty = "isAutoGenerated";
    ...
    var fixTableRowCellStructure = (
        ...
        angular.forEach(findChildrenByTagName(rowElement, cellTag), (existingCellElement: ng.IAugmentedJQuery) => {
            if (existingCellElement.attr(isAutoGeneratedAttribute)) {
            ...
            standardCellElement =
                findChildByTagName(
                    findChildByTagName(
                        ...
                        "tr"),
                    cellTag);
            standardCellElement.attr("data-ng-repeat", "columnOptions in gridOptions.gridColumnDefs");
            standardCellElement.attr(isAutoGeneratedAttribute, "true");

            var cellContentsWrapperElement = angular.element("<div></div>");
            cellContentsWrapperElement.attr(cellTemplateDirectiveAttribute, "");

            rowElement.append(standardCellElement);
