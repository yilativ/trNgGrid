...
module TrNgGrid{
    ...
    class GridController{
                ...
                if (newItemsLength) {
                    ...
                    for (var propName in this.gridOptions.items[0]) {
                        ...
                        if (!propName.match(/^[_\$]/g)) {
                            this.registerColumn(ColumnDefinitionSource.Object, {
                                fieldName: propName,
                                isCustomized: false
                            });
                        }
        ...
        registerColumn(sourceType: ColumnDefinitionSource, gridColumn: IGridColumn):IGridColumnDefinition {
        ...
        setupColumn(fieldName:string, sourceType:ColumnDefinitionSource, gridOptions?: IGridColumnOptions) {
    ...
    angular.module("trNgGrid", [])
        ...
        ////            transclude: 'element',
        ////            //template: "<th></th>", // replaced by transclusion
        ////            compile: (instanceElement: ng.IAugmentedJQuery, tAttrs: ng.IAttributes) => {
        ////                debugger;
        ////                return {
        ////                    pre: (isolatedScope: any, instanceElement: ng.IAugmentedJQuery, tAttrs: ng.IAttributes, controller: GridController, transcludeFn: ng.ITranscludeFunction) => {
        ////                        var columnOptions = <IGridColumnDefinition>isolatedScope;
        ////                        // we need to do here is to grab the settings and register them
        ////                        controller.setupColumn(isolatedScope.fieldName, ColumnDefinitionSource.Header, columnOptions);

        ////                        // compile on our own grounds, escape the isolation
        ////                        transcludeFn((<ng.IScope>isolatedScope).$parent.$new(), (transcludedElement: ng.IAugmentedJQuery) => {
        ////                            debugger;
