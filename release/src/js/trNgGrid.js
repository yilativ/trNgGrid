...
(function (TrNgGrid) {
    ...
    var ColumnDefinitionSource;
    (function (ColumnDefinitionSource) {
        ColumnDefinitionSource[ColumnDefinitionSource["Header"] = 0] = "Header";
        ColumnDefinitionSource[ColumnDefinitionSource["Body"] = 1] = "Body";
    })(ColumnDefinitionSource || (ColumnDefinitionSource = {}));
    ...
    */
    ...
    var GridController = (function () {
        ...
        GridController.prototype.initializeColumnDefinitions = function (gridScope) {
                ...
                if (newItemsLength) {
                    for (var propName in _this.gridOptions.items[0]) {
                        ...
                        if (!propName.match(/^[_\$]/g)) {
                            _this.registerColumn(propName, 0 /* Header */);
                        }
                    }
                }
            });
            ...
            this.gridOptions.gridColumnDefs = [];
            gridScope.displayedGridColumnDefs = [];
            gridScope.$watchCollection("gridOptions.gridColumnDefs", function (newGridColumnDefs) {
                // TODO: not enough!!!!
                if (newGridColumnDefs.length > 0 && _this.columnDefsFieldsWatcherDeregistrationFct) {
                    _this.columnDefsFieldsWatcherDeregistrationFct();
        ...
        GridController.prototype.registerColumn = function (fieldName, sourceType, isCustomized, columnOptions) {
            ...
            if (columnDefIndex >= this.gridOptions.gridColumnDefs.length) {
                ...
                columnDefOptions = angular.extend(columnOptions || {}, {
                    fieldName: fieldName,
                    definitionSource: {},
                    columnIndex: {},
                    isCustomized: {},
    ...
    var fixTableRowCellStructure = function (sectionTag, rowElement, cellTag, cellDirectiveAttribute, cellTemplateDirectiveAttribute, cellAutoGeneratedDirectiveAttribute, rowCellDecoratorFct) {
        // make sure the cell structure is in place
        var standardCellElement;

        angular.forEach(findChildrenByTagName(rowElement, cellTag), function (existingCellElement) {
        ...
        if (!standardCellElement) {
            ...
            standardCellElement = findChildByTagName(findChildByTagName(findChildByTagName(angular.element("<table><" + sectionTag + "><tr><" + cellTag + "></" + cellTag + "></tr></" + sectionTag + "></table>"), sectionTag), "tr"), cellTag);
    ...
    var fixTableStructure = function (gridElement) {
        ...
        // deal with the body
        fixTableSectionStructure(gridElement, "tbody", function (sectionElement) {
            ...
            fixTableSectionRowStructure(sectionElement, function (rowElement, isFirst, isLast) {
                if (isFirst) {
                    ...
                    fixTableRowCellStructure("tbody", rowElement, "td", cellBodyDirectiveAttribute, cellBodyTemplateDirectiveAttribute, cellBodyAutoGeneratedDirectiveAttribute, function (standardCellElement) {
        ...
        fixTableSectionStructure(gridElement, "tfoot", function (sectionElement) {
            sectionElement.attr(footerDirectiveAttribute, "");
            fixTableSectionRowStructure(sectionElement, function (rowElement, isFirst, isLast) {
                if (isLast) {
                    fixTableRowCellStructure("tfoot", rowElement, "td", cellFooterDirectiveAttribute, cellFooterTemplateDirectiveAttribute, cellFooterAutoGeneratedDirectiveAttribute, function (standardCellElement) {
        ...
        fixTableSectionStructure(gridElement, "thead", function (sectionElement) {
            ...
            fixTableSectionRowStructure(sectionElement, function (rowElement, isFirst, isLast) {
                if (isFirst) {
                    fixTableRowCellStructure("thead", rowElement, "th", cellHeaderDirectiveAttribute, cellHeaderTemplateDirectiveAttribute, cellHeaderAutoGeneratedDirectiveAttribute, function (standardCellElement) {
                        standardCellElement.attr("data-ng-repeat", "columnOptions in displayedGridColumnDefs");
                    });
                }
            });
        ...
        function () {
            return {
                ...
                compile: function (instanceElement, tAttrs) {
                    return {
                        pre: function (gridColumnScope, instanceElement, tAttrs, controller, transcludeFn) {
            ...
            return {
                ...
                compile: function (instanceElement, tAttrs) {
                    return function (isolatedScope, instanceElement, tAttrs, controller, transcludeFn) {
                        ...
                        isolatedScope = isolatedScope.$new();
                        isolatedScope.isCustomized = null;

                        // register the settings
                        columnDefinition = controller.registerColumn(fieldName, 0 /* Header */, isCustomized, isolatedScope);

                        //compile on our own grounds, escape the isolation
                        transcludeFn(gridColumnScope, function (transcludedElement, gridColumnScope) {
