...
(function (TrNgGrid) {
    ...
    (function (ColumnDefinitionSource) {
        ...
        ColumnDefinitionSource[ColumnDefinitionSource["Object"] = 2] = "Object";
    ...
    */
    ...
    var GridController = (function () {
        ...
        GridController.prototype.registerColumn = function (sourceType, gridColumn) {
        ...
        GridController.prototype.setupColumn = function (fieldName, sourceType, gridOptions) {
    ...
    var fixTableRowCellStructure = function (sectionTag, rowElement, cellTag, cellDirectiveAttribute, cellTemplateDirectiveAttribute, rowCellDecoratorFct) {
    ...
    var fixTableStructure = function (gridElement) {
        ...
        fixTableSectionStructure(gridElement, "tbody", function (sectionElement) {
            ...
            fixTableSectionRowStructure(sectionElement, function (rowElement, isFirst, isLast) {
                if (isFirst) {
                    ...
                    fixTableRowCellStructure("tbody", rowElement, "td", cellBodyDirectiveAttribute, cellBodyTemplateDirectiveAttribute, function (standardCellElement) {
        ...
        fixTableSectionStructure(gridElement, "tfoot", function (sectionElement) {
            ...
            fixTableSectionRowStructure(sectionElement, function (rowElement, isFirst, isLast) {
                if (isLast) {
                    fixTableRowCellStructure("tfoot", rowElement, "td", cellFooterDirectiveAttribute, cellFooterTemplateDirectiveAttribute, function (standardCellElement) {
        ...
        fixTableSectionStructure(gridElement, "thead", function (sectionElement) {
            ...
            fixTableSectionRowStructure(sectionElement, function (rowElement, isFirst, isLast) {
                if (isFirst) {
                    fixTableRowCellStructure("thead", rowElement, "th", cellHeaderDirectiveAttribute, cellHeaderTemplateDirectiveAttribute, function (standardCellElement) {
                        standardCellElement.attr("data-ng-repeat", "columnOptions in displayedGridColumnDefs");
                    });
                }
            });
